          ...
          <aside className="decision-preview" aria-label="Sample migration decision">
            <div className="product-window">
              ...
              <div className="product-window-body">
                ...
                <div className="first-slice"><span><small>Safest first slice</small><strong>{sample.estimate.firstSlice.name}</strong></span><b>→</b><span><small>Success gate</small><strong>Benchmark + compatibility</strong></span></div>
